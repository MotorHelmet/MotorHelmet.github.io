  ...
  //   let channel = await relay.subscribe(sht30__From__RasPI);
...
async function main() {
  ...
  let relay = RelayServer("achex", "chirimenSocket" , nodeWebSocketLib, "https://chirimen.org");
  console.log("RelayServerの接続完了");
  let channelSht30 = await relay.subscribe(sht30__From__RasPI);
  let channelMoisture = await relay.subscribe(moisture__From__RasPI);
